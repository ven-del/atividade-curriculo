    ...
    <section>
      ...
      <div className="space-y-4 print:grid print:grid-cols-2 print:gap-4 print:space-y-0">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-1.5 print:gap-0.5">
            {hardskills.map((skill) => (
              <Badge 
                key={skill.id} 
                className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-100 print:bg-transparent print:text-gray-800 print:border-none print:p-0 print:justify-start text-xs justify-center"
              >
                {skill.nome}
              </Badge>
            ))}
          ...
          <div className="grid grid-cols-1 gap-1.5 print:gap-0.5">
            {softskills.map((skill) => (
              <Badge 
                key={skill.id} 
                variant="outline"
                className="print:border-none print:text-gray-800 print:bg-transparent print:p-0 print:justify-start text-xs justify-center"
              >
                {skill.nome}
              </Badge>
            ))}
